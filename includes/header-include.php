<div class="section section-main-header" role="banner">
	<div class="logo">Point.B</div>
	<nav id="main-nav" role="navigation" class="nav nav-main">
		<a href="main-nav" class="btn-nav">
			<span class="text">Open navigation</span>
			<span class="icon">
				<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 748.9 436.8" enable-background="new 0 0 748.9 436.8" xml:space="preserve">
